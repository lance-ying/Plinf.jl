...
function run_problem_1(option::Integer)
    ...
    if option == 1
        ...
        plan = collect(Term, plan)
        captions = ["Human: \"Can you unlock the red door?\"","...","...","...", "..."]
    ...
    if option == 2
        ...
        plan = collect(Term, plan)
        captions = ["Human: \"Can you help me unlock the blue door?\"","...","...","...", "...","..."]
...
function run_problem_2(option::Integer)
    ...
    if option == 1
        ...
        viz_l(splitpoints=[1,10, 20, 34], traj, domain,captions=captions, problem="p2_g1")
...
function run_problem_3(option::Integer)
    ...
    if option == 1
        ...
        traj = PDDL.simulate(domain, state, plan)   
        captions = ["Human: \"Can I have the red key?\"","...","...","...", "..."]
    ...
    if option == 4
        ...
        traj = PDDL.simulate(domain, state, plan) 
        captions = ["Human: \"Can you give me the red and the blue key?\"","...","...","...", "...","..."]
    ...
    if option == 2
        ...
        traj = PDDL.simulate(domain, state, plan)   
        captions = ["Human: \"Can you pass me the red key?\"","...","...","...", "..."]
        viz_l(traj, domain; splitpoints=[1,18, 28, 34],captions=captions,problem="p3_g2")
    end
    ...
    if option == 3
        ...
        traj = PDDL.simulate(domain, state, plan)   
        captions = ["Human: \"Can you pass me the red key?\"","...","...","...", "..."]
        viz_l(traj, domain;splitpoints=[1,19, 28, 34],captions=captions,problem="p3_g3")
    end
...
function run_problem_4(option::Integer)
    ...
    if option ==1
        ...
        traj = PDDL.simulate(domain, state, plan)   
        captions = ["Human: \"Can you pass me the red key?\"","...","...","...","..." ]
        viz_l(traj, domain;splitpoints=[1,10, 18, 25],captions=captions, problem="p4_g1")
    end
    ...
    if option == 4
        ...
        traj = PDDL.simulate(domain, state, plan)   
        captions = ["Human: \"Pass me the red and yellow key.\"","...","...","...", "...", "..."]
