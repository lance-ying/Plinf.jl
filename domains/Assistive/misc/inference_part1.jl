...
costs = (pickup=1.0,unlock=1.0,up=1.0, down=1.0, left=1.0, right=1.0, noop=0.6)

action_dict = Dict(
    
"1.1"=>@pddl("(left human)",  "(left human)",  "(left human)","(left human)"),
"2.1"=> @pddl("(up human)", "(up human)",  "(up human)", "(left human)", "(left human)"),
"2.2"=>@pddl("(up human)",  "(up human)",  "(up human)", "(left human)", "(left human)", "(left human)", "(left human)",  "(left human)", "(left human)"),
...
"4.1"=>@pddl("(right human)", "(right human)",  "(right human)", "(right human)" ),
"4.2"=>@pddl("(right human)", "(right human)",  "(right human)","(right human)" ),
"5.1"=>@pddl("(down human)",  "(down human)", "(right human)"),
"8.1"=>@pddl("(right human)",  "(right human)"),
"8.2"=>@pddl("(down human)",  "(down human)"),
...
"11.1"=>@pddl("(up human)", "(up human)", "(up human)","(up human)","(right human)" ,"(right human)"),
"11.2"=>@pddl("(up human)" , "(up human)" ,"(right human)" ,"(right human)" ),
...
"17.1"=>@pddl("(down human)" , "(down human)" ,"(right human)" ),
"18.1"=>@pddl("(left human)" , "(up human)" ),
"19.1"=>@pddl("(right human)" , "(right human)" ),
"20.1"=>@pddl("(down human)" , "(down human)" , "(left human)" , "(pickup human key1)" , "(right human)" , "(right human)" )
...
planner = RTHS(heuristic=heuristic, n_iters=1, max_nodes=200) 
...
obs_traj = PDDL.simulate(domain, state, action_dict["11.2"])
