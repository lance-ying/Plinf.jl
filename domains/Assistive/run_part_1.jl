...
plan_vec=rollout_sol(domain, planner, pf_state.traces[1][:timestep => len_plan => :env], pf_state.traces[1][:timestep => len_plan => :agent => :plan].sol, pf_state.traces[1][:timestep => len_plan => :agent =>:goal])