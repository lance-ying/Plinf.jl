...
"p4_g3"=>@pddl("(noop human)", "(up robot)", "(noop human)", "(up robot)", "(noop human)", "(left robot)", "(noop human)", "(left robot)", "(noop human)", "(left robot)", "(noop human)", "(down robot)", "(noop human)", "(left robot)", "(noop human)", "(pickupr robot key2)", "(noop human)", "(up robot)", "(noop human)", "(pickupr robot key1)", "(noop human)", "(right robot)", "(noop human)", "(right robot)", "(noop human)", "(right robot)", "(noop human)", "(right robot)", "(noop human)", "(down robot)", "(noop human)", "(down robot)", "(noop human)", "(down robot)", "(noop human)", "(handover robot human key2)","(noop human)",  "(handover robot human key1)",  "(down human)", "(noop robot)" ,  "(unlockh human key2 door2)","(noop robot)" , "(down human)", "(noop robot)", "(unlockh human key1 door4)", "(noop robot)", "(down human)", "(noop robot)", "(down human)", "(noop robot)", "(pickuph human gem3)"),
...
"p4_g1" => "Can you pass me the red key?",  "p4_g2" => "Can you pass me the yellow key?",  "p4_g3" => "Can you pass me the red and yellow key?", "p4_g4" => "Pass me the red key.",
...
storyboard_goal_lines!(storyboard, rating_matrix, [1,8, 18, 28, 40], show_legend=true)
future_action = Vector{Compound}()
s = state
for _ in 1:60
