...
action_dict = Dict(1=>@pddl("(takeout human wine1 fridge1)","(noop robot)", "(takeout human wineglass1 cabinet3)"),
          ...
          8=>@pddl("(noop human)"),
          9=>@pddl("(noop human)"),
          10=>@pddl("(takeout human plate1 cabinet2)","(noop robot)", "(takeout human wine1 fridge1)","(noop robot)", "(takeout human cheese1 fridge1)"),
          11=>@pddl("(noop human)"),
          12=>@pddl("(takeout human cutleryfork1 cabinet4)","(noop robot)", "(takeout human cutleryfork2 cabinet4)","(noop robot)", "(takeout human cutleryfork3 cabinet4)"),
          13=>@pddl("(takeout human cutleryfork1 cabinet4)","(noop robot)", "(takeout human cutleryfork2 cabinet4)","(noop robot)", "(takeout human cutleryfork3 cabinet4)","(noop robot)","(takeout human cutleryknife1 cabinet4)","(noop robot)", "(takeout human cutleryknife2 cabinet4)","(noop robot)", "(takeout human cutleryknife3 cabinet4)" ),
          14=>@pddl("(takeout human cutleryfork1 cabinet4)","(noop robot)", "(takeout human cutleryfork2 cabinet4)","(noop robot)", "(takeout human cutleryfork3 cabinet4)","(noop robot)","(takeout human cutleryfork4 cabinet4)","(noop robot)", "(takeout human cutleryknife1 cabinet4)","(noop robot)"),
          15=>@pddl("(takeout human tomato1 fridge1)","(noop robot)","(takeout human cucumber1 fridge1)","(takeout human onion1 fridge1)"),
          16=>@pddl("(takeout human chicken1 fridge1)","(noop robot)","(takeout human cucumber1 fridge1)"),
          17=>@pddl("(noop human)"),
          18=>@pddl("(noop human)"),
          19=>@pddl("(takeout human wineglass1 cabinet3)","(noop robot)","(takeout human wineglass2 cabinet3)","(noop robot)","(takeout human wineglass3 cabinet3)"),
          20=>@pddl("(takeout human juice1 fridge1)","(noop robot)","(takeout human waterglass1 cabinet3)","(noop robot)")

)

    
#bowls - cabinet1 plates - cabinet2 glasses - cabinet3 forks/knifes - cabinet4 cuttingstuff - cabinet5
...
utterance_dict=Dict(
    ...
    5=>"Can you get the potato and onion for the stew?",
    6=>"Can you get 3 glasses?",
    7=>"Can you get the bowls?",
    8=>"Can you help me find some forks and knives?",
